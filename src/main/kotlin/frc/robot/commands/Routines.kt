...
fun initDashboard(elevator: ElevatorSubsystem, algaeIntake: AlgaeIntakeSubsystem) {
    ...
    SmartDashboard.putData("Take Alagae: l1", Routines.takeAlgae(0.0, elevator, algaeIntake));
    SmartDashboard.putData("Take Alagae: l2", Routines.takeAlgae(0.0, elevator, algaeIntake));
    SmartDashboard.putData("Take Alagae: l3", Routines.takeAlgae(0.0, elevator, algaeIntake));
    SmartDashboard.putData("Take Alagae: l4", Routines.takeAlgae(0.0, elevator, algaeIntake));
