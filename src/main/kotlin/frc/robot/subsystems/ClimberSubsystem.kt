...
class ClimberSubsystem: SubsystemBase(){
    private val leftMotor:CANSparkMax = CANSparkMax(14, CANSparkLowLevel.MotorType.kBrushless)
    private val rightMotor:CANSparkMax = CANSparkMax(15, CANSparkLowLevel.MotorType.kBrushless)
